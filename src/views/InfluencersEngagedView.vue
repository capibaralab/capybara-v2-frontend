...
import { findInfluencerById, MOCK_INFLUENCERS } from '../services/mockInfluencers'
        ...
        <template v-if="expandedRows[row.influencerId]">
          <ul class="campaign-list">
            <li v-for="c in row.campaigns" :key="c.campaignId" class="campaign-list-item">
              <RouterLink :to="`/advertiser/campaigns/${c.campaignId}`" class="campaign-list-name" @click.stop>
                {{ c.campaignName }}
              </RouterLink>
          ...
          <div class="card-collab-row">
            <RouterLink :to="`/advertiser/influencers/${row.influencerId}`" class="btn btn-secondary btn-sm">
              Portfolio
            </RouterLink>
