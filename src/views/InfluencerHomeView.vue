  ...
  <main class="container influencer-home">
    ...
    <section class="strip-section">
      <div class="strip-header">
        ...
        <RouterLink to="/influencer/offers" class="see-all-link">See all →</RouterLink>
      </div>
      ...
      <div v-else class="strip-row">
        <div v-for="item in suggestions.slice(0, 6)" :key="item.offerId" class="strip-card">
          <RouterLink to="/influencer/offers" class="strip-card-link">
    ...
    <section class="strip-section">
      <div class="strip-header">
        ...
        <RouterLink to="/influencer/collaborations/live" class="see-all-link">See all →</RouterLink>
      </div>
      ...
      <div v-else class="strip-row">
        <RouterLink
          ...
          :key="item.offerId"
          to="/influencer/collaborations/live"
          class="strip-card"
        >
          <img :src="item.productImage" alt="" class="strip-card-image" />
          <div class="strip-card-body">
    ...
    <section class="strip-section">
      ...
      <div v-else class="strip-row">
        <RouterLink
          ...
          :key="item.offerId"
          to="/influencer/collaborations/completed"
          class="strip-card"
        >
          <img :src="item.productImage" alt="" class="strip-card-image" />
          <div class="strip-card-body">
